 ...
 * @author Lenovo
 */
public class AfficherLocation extends BaseForm {
    Form current;
public ArrayList<Location> Location;
    public AfficherLocation(Form previous,Resources res) {
        super("liste Location", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste Locations");
    ...
    new AfficherLocation(current, res).show();
    });
        
       
  /*     Location = ServiceLocation.getInstance().getAllLocations();
       for(Location loc : Location){ 
           addButton(res.getImage("news-item-1.jpg"),loc.getDate().toString()+ "\n" +loc.getHeure().toString()+ "\n" +loc.getDuree().toString()+ "\n" +loc.getIdAbonnement());
