 ...
 * @author user
 */
public class DetailSujet extends BaseForm {
    ...
    public DetailSujet(Sujet sujet ,Resources res) {
        ...
        RadioButton messages = RadioButton.createToggle("message", barGroup);
        messages.setUIID("SelectBar");
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1, messages),
        ...
        bindButtonSelection(messages , arrow);
