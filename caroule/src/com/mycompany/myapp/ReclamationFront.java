 ...
 * @author PC
 */
public class ReclamationFront extends BaseForm {
    Form current;
    Reclamation c;
public ArrayList<Reclamation> Reclamations;
    public ReclamationFront(Form previous,Resources res) {
       ...
       // RadioButton all = RadioButton.createToggle("All", barGroup);
        ...
        Reclamation.setUIID("SelectBar");
         RadioButton Maintenance = RadioButton.createToggle("Maintenance", barGroup);
        Maintenance.setUIID("SelectBar");
       // RadioButton myFavorite = RadioButton.createToggle("My Favorites", barGroup);
        //myFavorite.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(2, Reclamation,Maintenance),
       ...
       // all.setSelected(true);
        ...
        addShowListener(e -> {
            ...
            updateArrowPosition(Reclamation, arrow);
        });
        //bindButtonSelection(all, arrow);
        bindButtonSelection(Reclamation, arrow);
       bindButtonSelection(Maintenance, arrow);
...
Reclamations =ServiceReclamation.getInstance().getAllReclamation();
 
for (Reclamation e :Reclamations)
{ addButton(res.getImage("news-item-1.jpg"),e.getObjet().toString()+ "\n" +e.getDescription().toString()+ "\n" +e.getDate().toString()+ "\n" ,false, 26, 32,res,+e.getId());
      //  sp.setText(sp.getText()+"\n"+e.getDescription().toString());
    
}

                    Maintenance.addActionListener((ActionListener) (ActionEvent e) -> {
        new MaintenanceFront(previous, res).show();       
