 ...
 * @author Ahmed Elmoez
 */
public class AffichageAchat extends BaseForm {
    
    Form current;
public ArrayList<Achat> Achats;
    public AffichageAchat(Form previous,Resources res) {
        super("liste Achat", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste Achats");
